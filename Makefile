...
IPHONE_17_PRO_RELAY_HOSTS ?= amir-m5.fairy-salmon.ts.net:4510,home.fairy-salmon.ts.net:4510,amirs-m3-max-new.fairy-salmon.ts.net:4510
...
CODEX_DOCK_RENAME_PROOF_DETAIL_TITLE ?=
export CODEX_DOCK_RENAME_PROOF_HOST_ID
export CODEX_DOCK_RENAME_PROOF_THREAD_ID
export CODEX_DOCK_RENAME_PROOF_ORIGINAL_TITLE
export CODEX_DOCK_RENAME_PROOF_NEW_TITLE
export CODEX_DOCK_RENAME_PROOF_DETAIL_TITLE
...
SIM_UI_REALDATA_RUN_ID ?= $(shell date -u +%Y%m%dT%H%M%SZ)
SIM_UI_REALDATA_ROOT ?= /tmp/codex-client/sim-ui-realdata-realtime-$(SIM_UI_REALDATA_RUN_ID)
SIM_UI_REALDATA_SCENARIOS ?= rename-title archive-toggle
SIM_UI_REALDATA_HOSTS ?= $(APP_SERVER_HOST):$(DOCK_RELAY_PORT)
SIM_UI_REALDATA_RELAY_WS ?= ws://$(APP_SERVER_HOST):$(DOCK_RELAY_PORT)
SIM_UI_REALDATA_SAMPLE_MS ?= 250
...
help:
	...
	@printf "%s\n" "  rtk make sim-ui-realdata-realtime-proof SIM='iPhone 17' Run real-data rename/archive realtime UI proof"
