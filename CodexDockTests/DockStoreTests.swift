...
final class DockStoreTests: XCTestCase {
    ...
    func testDockStatusVocabularyAndSourceFiltersUseNormalizedRows() {
        XCTAssertEqual(DockRowStatusKind.running.label, "Codex is working")
        XCTAssertEqual(DockRowStatusKind.needsInput.label, "Needs answer")
        XCTAssertEqual(DockRowStatusKind.needsApproval.label, "Needs approval")
        XCTAssertEqual(DockRowStatusKind.idle.label, "Ready")
        XCTAssertEqual(DockRowStatusKind.error.label, "Error")
        XCTAssertEqual(DockRowStatusKind.dormant.label, "Saved")
        XCTAssertEqual(DockRowStatusKind.unknown.label, "Unknown")
        XCTAssertNil(DockRowStatusKind.dormant.visibleBadgeLabel)
        XCTAssertNil(DockRowStatusKind.idle.visibleBadgeLabel)
        XCTAssertNil(DockRowStatusKind.unknown.visibleBadgeLabel)
        XCTAssertEqual(DockRowStatusKind.running.visibleBadgeLabel, "Codex is working")
        XCTAssertEqual(DockRowStatusKind.needsInput.visibleBadgeLabel, "Needs answer")
        ...
        XCTAssertEqual(DockRowStatusKind.running.threadDetailStatusLabel, "Codex is working")
        XCTAssertEqual(DockRowStatusKind.needsInput.threadDetailStatusLabel, "Your turn · Needs answer")
        XCTAssertEqual(DockRowStatusKind.needsApproval.threadDetailStatusLabel, "Your turn · Needs approval")
        XCTAssertEqual(DockRowStatusKind.idle.threadDetailStatusLabel, "Your turn · Ready")
        XCTAssertEqual(DockRowStatusKind.error.threadDetailStatusLabel, "Error")
        XCTAssertNil(DockRowStatusKind.dormant.threadDetailStatusLabel)
        XCTAssertNil(DockRowStatusKind.unknown.threadDetailStatusLabel)
