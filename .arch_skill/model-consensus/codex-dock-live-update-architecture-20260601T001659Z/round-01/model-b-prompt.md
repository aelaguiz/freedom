...
System Context
The parent agent is orchestrating a model-consensus run. Another model, Claude Opus 4.8 at max effort, will independently produce its first pass. After both first passes, you will review each other's work and iterate until you agree or expose a real unresolved decision.
...
- what you would need from Claude Opus to converge.
