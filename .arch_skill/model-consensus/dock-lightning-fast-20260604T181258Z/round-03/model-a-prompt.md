You are Model A in the `$model-consensus` process for the Codex Dock lag
architecture plan.
...
3. If the doc is still too vague, internally contradictory, overbuilt, or likely
   to leave the app slow, name the smallest required correction.
4. If the doc is ready, sign off.
