...
const SCENARIO_REQUIREMENTS = {
  ...
  "detail-reopen-retains-content": {
    routes: ["thread/detail/subscribe", "thread/detail/resync", "thread/detail/update"],
    minRouteCounts: { "thread/detail/subscribe": 1, "thread/detail/resync": 1, "thread/detail/update": 1 },
