...
const ROUTE_NAMES = Object.freeze({
  ...
  statusz: "statusz",
  metricsz: "metricsz",
  debugSessions: "debugz/sessions",
  routesz: "routesz",
  statez: "statez",
  syncz: "syncz",
  subscriptionsz: "subscriptionsz",
  dbz: "dbz",
  explainThread: "explainz/thread/{threadID}",
  tracesRecent: "tracesz/recent",
  tracesOperation: "tracesz/{operationID}",
  selftestz: "selftestz",
  bundlez: "bundlez",
  ...
  relayStateSnapshot: "relay/state/snapshot",
...
const ROUTE_CONFIGS = Object.freeze({
  ...
  [ROUTE_NAMES.debugSessions]: route({
    name: ROUTE_NAMES.debugSessions,
    kind: "http",
    probeSafety: PROBE_SAFETY.MANUAL_ONLY,
    payloadPolicy: "runtime-debug-summary",
  }),
  ...
  [ROUTE_NAMES.statez]: route({
    name: ROUTE_NAMES.statez,
    kind: "http",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    payloadPolicy: "state-summary",
  }),
  [ROUTE_NAMES.syncz]: route({
    name: ROUTE_NAMES.syncz,
    kind: "http",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    payloadPolicy: "sync-summary",
  }),
  [ROUTE_NAMES.subscriptionsz]: route({
    name: ROUTE_NAMES.subscriptionsz,
    kind: "http",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    payloadPolicy: "subscription-summary",
  }),
  [ROUTE_NAMES.dbz]: route({
    name: ROUTE_NAMES.dbz,
    kind: "http",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    payloadPolicy: "db-summary",
  }),
  [ROUTE_NAMES.explainThread]: route({
    name: ROUTE_NAMES.explainThread,
    kind: "http",
    probeSafety: PROBE_SAFETY.MANUAL_ONLY,
    payloadPolicy: "thread-explain-summary",
  }),
  [ROUTE_NAMES.tracesRecent]: route({
    name: ROUTE_NAMES.tracesRecent,
    kind: "http",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    payloadPolicy: "trace-summary",
  }),
  [ROUTE_NAMES.tracesOperation]: route({
    name: ROUTE_NAMES.tracesOperation,
    kind: "http",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    payloadPolicy: "single-trace",
  }),
  [ROUTE_NAMES.selftestz]: route({
    name: ROUTE_NAMES.selftestz,
    kind: "http",
    probeSafety: PROBE_SAFETY.MANUAL_ONLY,
    payloadPolicy: "probe-summary",
  }),
  [ROUTE_NAMES.bundlez]: route({
    name: ROUTE_NAMES.bundlez,
    kind: "http",
    probeSafety: PROBE_SAFETY.MANUAL_ONLY,
    payloadPolicy: "diagnostic-bundle",
  }),
  ...
  [ROUTE_NAMES.threadList]: route({
    name: ROUTE_NAMES.threadList,
    kind: "json-rpc",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    appCritical: true,
    budgetMs: 10_000,
    payloadPolicy: "paged-list-summary",
  }),
  [ROUTE_NAMES.threadSearch]: route({
    name: ROUTE_NAMES.threadSearch,
    kind: "json-rpc",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    appCritical: true,
    budgetMs: 10_000,
  ...
  [ROUTE_NAMES.threadGoalGet]: route({
    name: ROUTE_NAMES.threadGoalGet,
    kind: "json-rpc",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    appCritical: true,
    budgetMs: 10_000,
  }),
  [ROUTE_NAMES.threadLoadedList]: route({
    name: ROUTE_NAMES.threadLoadedList,
    kind: "json-rpc",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    appCritical: true,
    budgetMs: 10_000,
  ...
  [ROUTE_NAMES.threadRead]: route({
    name: ROUTE_NAMES.threadRead,
    kind: "json-rpc",
    probeSafety: PROBE_SAFETY.MANUAL_ONLY,
    appCritical: true,
    budgetMs: 15_000,
    payloadPolicy: "thread-summary-no-content",
  }),
  [ROUTE_NAMES.threadResume]: route({
    name: ROUTE_NAMES.threadResume,
    kind: "json-rpc",
    probeSafety: PROBE_SAFETY.PASSIVE_ONLY,
    appCritical: true,
    budgetMs: 15_000,
  }),
  [ROUTE_NAMES.threadTurnsList]: route({
    name: ROUTE_NAMES.threadTurnsList,
    kind: "json-rpc",
    probeSafety: PROBE_SAFETY.MANUAL_ONLY,
    appCritical: true,
    budgetMs: 15_000,
  ...
  [ROUTE_NAMES.dockSubscribe]: route({
    ...
    appCritical: true,
    budgetMs: 15_000,
    payloadPolicy: "dock-session-summary",
  }),
  ...
  [ROUTE_NAMES.relayStateSnapshot]: route({
    name: ROUTE_NAMES.relayStateSnapshot,
    kind: "json-rpc",
    probeSafety: PROBE_SAFETY.AUTO_PROBE_SAFE,
    budgetMs: 10_000,
    payloadPolicy: "state-snapshot-summary",
  }),
